var d=Object.defineProperty;var l=(o,e,c)=>e in o?d(o,e,{enumerable:!0,configurable:!0,writable:!0,value:c}):o[e]=c;var s=(o,e,c)=>(l(o,typeof e!="symbol"?e+"":e,c),c);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function c(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(t){if(t.ep)return;t.ep=!0;const i=c(t);fetch(t.href,i)}})();const g=`
    .widget__container * {
    ...
    .button__container {
        box-shadow: 0 0 9px 4px rgba(0, 0, 0, 0.1), 0 0 18px 18px rgba(0, 0, 0, 0.08);
        border: none;
...
`,m={OEON833:{partner_id:"OEON833",partner_ticketing_activity_ids:"400864,431017",partner_ticketing_language:"sv",partner_ticketing_currency:"sek",baseUrl:"",position:"right",languages:[{code:"en-US",name:"English"},{code:"de-DE",name:"German (Germany)"},{code:"de-AT",name:"German (Austria)"},{code:"de-CH",name:"German (Switzerland)"},{code:"fr-FR",name:"French"},{code:"es-ES",name:"Spanish (Spain)"},{code:"es-MX",name:"Spanish (Mexico)"},{code:"da-DK",name:"Danish"},{code:"nl-NL",name:"Dutch"},{code:"it-IT",name:"Italian"},{code:"pl-PL",name:"Polish"},{code:"pt-BR",name:"Portuguese (Brazil)"},{code:"pt-PT",name:"Portuguese (Portugal)"},{code:"fi-FI",name:"Finnish"},{code:"no-NO",name:"Norwegian"},{code:"ru-RU",name:"Russian"},{code:"sv-SE",name:"Swedish"},{code:"ja-JP",name:"Japanese"}]}};class f{constructor(){s(this,"position","");s(this,"open",!1);s(this,"widgetContainer",null);this.config=this.getConfiguration(),this.position=this.getPosition(this.config.position),this.open=!1,this.initialize(),this.injectStyles()}getConfiguration(){const e=Array.from(document.getElementsByTagName("script"));let c="";return e.forEach(n=>{n.dataset.gygPartnerHash&&(c=n.dataset.gygPartnerHash)}),console.log(e),console.log(c),m[c]}getPosition(e){if(e==="right"||e==="left")return{top:"200px",[e]:"0px"};{const[c,n]=e.split("-");return{[c]:"30px",[n]:"30px"}}}async initialize(){const e=document.createElement("div");e.style.position="fixed",Object.keys(this.position).forEach(i=>e.style[i]=this.position[i]),document.body.appendChild(e);const c=document.createElement("button");c.classList.add("button__container");const n=document.createElement("span");n.innerHTML=p,n.classList.add("widget__icon"),this.widgetIcon=n;const t=document.createElement("span");t.innerHTML=h,t.classList.add("widget__icon","widget__hidden"),this.closeIcon=t,c.appendChild(this.widgetIcon),c.appendChild(this.closeIcon),c.addEventListener("click",this.toggleOpen.bind(this)),this.widgetContainer=document.createElement("div"),this.widgetContainer.classList.add("widget__hidden","widget__container"),this.createWidgetContent(),e.appendChild(this.widgetContainer),e.appendChild(c)}elementFromHTML(e){const c=document.createElement("template");return c.innerHTML=e.trim(),c.content.firstElementChild}createLink(e){let c="?";return c=c.concat("partner_id=",this.config.partner_id,"&"),c=c.concat("partner_ticketing_activity_ids=",this.config.partner_ticketing_activity_ids,"&"),c=c.concat("partner_ticketing_currency=",this.config.partner_ticketing_currency,"&"),c=c.concat("partner_ticketing_language=",e),c}createWidgetContent(){const e=this.elementFromHTML(`
      <header>
          <h3>Buy tickets in your language</h3>
      </header>
    `);e.classList.add("widget__header"),this.widgetContainer.appendChild(e);const c=document.createElement("div");c.classList.add("widget__body"),this.widgetContainer.appendChild(c),this.config.languages.forEach(n=>{const t=document.createElement("div");t.classList.add("widget__language");const i=document.createElement("span"),r="fi-"+n.code.split("-").pop().toString().toLowerCase();console.log(r),i.classList.add("fi",r),t.appendChild(i);const a=document.createElement("a");a.classList.add("widget__text"),a.innerHTML+=n.name,a.href=this.createLink(n.code.split("-").shift()),t.appendChild(a),c.appendChild(t)})}injectStyles(){const e=document.createElement("style");e.innerHTML=g.replace(/^\s+|\n/gm,""),document.head.appendChild(e)}toggleOpen(){this.open=!this.open,this.open?(this.widgetIcon.classList.add("widget__hidden"),this.closeIcon.classList.remove("widget__hidden"),this.widgetContainer.classList.remove("widget__hidden")):(this.widgetIcon.classList.remove("widget__hidden"),this.closeIcon.classList.add("widget__hidden"),this.widgetContainer.classList.add("widget__hidden"))}}function u(){return new f}u();
